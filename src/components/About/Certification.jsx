        ...
        <>
            <div className="grid items-center grid-cols-12 lg:mb-[176px] mb-[80px] ">
                <div className="col-span-12 lg:col-span-6" >
                    <h1 className=' lg:text-[59px] text-[36px] text-[#8BEAAD] font-medium lg:mb-[75px] mb-[20px] lg:text-start text-center ' data-aos="fade-up"
                        data-aos-offset="200"
                        data-aos-delay="100"
                        data-aos-duration="1000"
                        data-aos-easing="ease-in-out"
                        data-aos-mirror="true">Certification</h1>
                    <p className='text-[#F1F1F1] font-sans  font-semibold  leading-[33px] lg:text-start text-center ' data-aos="fade-up"
                        data-aos-offset="200"
                        data-aos-delay="500"
                        data-aos-duration="1000"
                        data-aos-easing="ease-in-out"
                        data-aos-mirror="true">Certified to craft exceptional user experiences, my UI/UX <br className='lg:flex hidden ' /> certification is a testament to my commitment to  <br className='lg:flex hidden ' />  excellence in design. Equipped with the latest industry <br className='lg:flex hidden ' />knowledge and best practices, I bring a strategic and  <br className='lg:flex hidden ' /> user-centric approach to every project. This certification <br className='lg:flex hidden ' /> not only validates my skills but also reflects my <br className='lg:flex hidden ' /> dedication to staying at the forefront of the dynamic <br className='lg:flex hidden ' /> UI/UX landscape.</p>
                </div>

...
const Photography = () => {
    ...
    return (
        ...
        <div className='mb-[81px] overflow-hidden'>
            <h2 className='text-[36px] font-Oswald  font-normal text-[#8BEAAD] mb-[19px] lg:text-start text-center '>Photography</h2>
            <p className='text-[24px] font-normal font-sans mb-[35px]  lg:text-start text-center '
            >Step into the human tapestry captured through my lens. In the photography section, faces become stories, and moments turn into emotions frozen in time.</p>
